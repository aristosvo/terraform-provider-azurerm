...
func TestMaintenanceConfigurationIDFormatter(t *testing.T) {
	actual := NewMaintenanceConfigurationID("12345678-1234-9876-4563-123456789012", "resGroup1", "cluster1", "maintenanceConfiguration1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.ContainerService/managedClusters/cluster1/maintenanceConfigurations/maintenanceConfiguration1"
	if actual != expected {
...
func TestMaintenanceConfigurationID(t *testing.T) {
	testData := []struct {
		...
		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.ContainerService/managedClusters/cluster1/maintenanceConfigurations/maintenanceConfiguration1",
			Expected: &MaintenanceConfigurationId{
