...
type Client struct {
	...
	ManagedInstanceAdministratorsClient             *mi.ManagedInstanceAdministratorsClient
	ManagedInstanceAzureADOnlyAuthenticationsClient *mi.ManagedInstanceAzureADOnlyAuthenticationsClient
...
func NewClient(o *common.ClientOptions) *Client {
	...
	managedInstanceAdministratorsClient := mi.NewManagedInstanceAdministratorsClientWithBaseURI(o.ResourceManagerEndpoint, o.SubscriptionId)
	o.ConfigureClient(&managedInstanceAdministratorsClient.Client, o.ResourceManagerAuthorizer)

	managedInstanceAzureADOnlyAuthenticationsClient := mi.NewManagedInstanceAzureADOnlyAuthenticationsClientWithBaseURI(o.ResourceManagerEndpoint, o.SubscriptionId)
