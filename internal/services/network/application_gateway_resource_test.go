...
func TestAccApplicationGateway_customErrorConfigurationsUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_application_gateway", "test")
	r := ApplicationGatewayResource{}
...
func (r ApplicationGatewayResource) httpCustomErrorConfigurations(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
